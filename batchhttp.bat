...
//THIS FILE HAS BEEN SLIGHTLY MODIFIED TO USE IN DISCORDBAT. DO NOT MODIFY
...
function printHelp() {
    WScript.Echo("Note: This script has been modified to work in discordbat. For use in own projects, please get the original file to prevent odd errors.")
...
//Some 2XX statuses intentionally left out
    switch (status) {
        case 200:
            WScript.Echo("Status: 200 OK");
            break;
        case 201:
            WScript.Echo("Status: 201 Created. Should be fine")
            break;
        case 202:
            WScript.Echo("Status: 202 Accepted. Should be fine")
            break;
        case 205:
            WScipt.Echo("Status: 205 Reset Content. Should be fine")
            break;
        case 206:
            WScript.Echo("Status 206 Partial Content. Should be fine")
            break;
        case 204:
            WScript.Echo("Status: 204 No Content. Should be fine")
            break;
        case 401:
            WScript.Echo("Status: 401. Possibly invalid token")
            break;
        case 429:
            WScript.Echo("Status: 429. You are being rate limited, oh no! Make sure to not get this a lot or you are going to have issues")
            break;
        default:
